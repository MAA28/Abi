...
$$\dfrac{2s}{a}=t^2\ |\sqrt{...}$$
	$$t=\sqrt{\dfrac{2s}{a}}=\sqrt{\dfrac{2d}{a}}=\sqrt{\dfrac{2dm}{F}}=\sqrt{\dfrac{2*0.06m*5*10^{-4}kg}{4.5*10^{-4}N}}\approx3.65*10^{-5}s$$
	
$$v=at=\dfrac{F}{m}*t= \dfrac{4.5*10^{-4}N}{5*10^{-4}kg} * 3.65 * 10^{-5} s=3.29*10^{-5} \frac{m}{s}$$
